...
<body>
    ...
    <div class="bg-primary-subtle">
        <h1 class="text-center p-3">Rapport Annuel 2022</h1>
    </div>
    ...
    <div class="container mb-4" id="rapport2022">
        ...
        <div class="row pt-2">
            ...
            <div class="col-md-8">
                <p>
                    2022 a été l'année des challenges et des défis! Les relever pour nous à permis de montrer à nos communautés qu'ils ne suffit pas de beaucoup pour faire de grandes choses mais plutôt de mutualiser nos efforts car c'est ensemble que tout est possible! <br>
                    C'est donc avec Fierté que nous continuons nos efforts pour le plus grand bonheur des populations.
                    <div>
                        <a href="./sterna.pdf" class="get-started" download="rapporAnnuel2022">Télécharger rapport</a>
                    </div>
                </p>
            </div>
        </div>
