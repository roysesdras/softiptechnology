...
<body>
    ...
    <div class="bg-primary-subtle">
        <h1 class="text-center p-3">Rapport Annuel 2020</h1>
    </div>
    ...
    <div class="container mb-4" id="rapport2022">
        ...
        <div class="row pt-2">
            ...
            <div class="col-md-8">
                <p>
                    Pour cette 1ère année d'exercice, Sterna Africa a su se démarquer en menant à bien sa mission, celle t'aider partout où le besoin se fait sentir malgré la crise à coronavirus. Cette année 2020 a été pleine de difficultés, d'expérience et de challenge car l'association devait se créer une place et elle y est arrivée mais le combat n'est pas encore terminé. Tant qu'il reste à faire, rien n'est fait dit-on...
                </p>
                <div>
