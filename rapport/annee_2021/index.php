...
<body>
    ...
    <div class="bg-primary-subtle">
        <h1 class="text-center p-3">Rapport Annuel 2021</h1>
    </div>
    ...
    <div class="container mb-4" id="rapport2022">
        ...
        <div class="row pt-2">
            ...
            <div class="col-md-8">
                <p>
                    L'année 2021 a été pour toutes les associations une année d'adaptation et d'innovation dû aux traces laissés par la Covid-19. Chaque organisation de la société civile devait faire ses preuves et c'est en ce sens que des projets et partenariats ont été entrepris pour maintenir la cadence et faire montre de professionnalisme. L'année était très chargée pour Sterna Africa et la mobilisation des volontaires sur toutes les antennes a été exceptionnelle car l'envie et le besoin d'aider se faisaient ressentir. Malgré les difficultés 2021 a été une année pleine de succès pour l'association.
                    <div>
                        <a href="./rapport.pdf" class="get-started" download="rapporAnnuel2021">Télécharger rapport</a>
                    </div>
                </p>
            </div>
        </div>
