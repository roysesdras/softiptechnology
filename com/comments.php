...
function show_write_comment_form($parent_id = -1) {
    ...
    <div class="write_comment" data-comment-id="' . $parent_id . '">
        <form>
            ...
            <textarea name="content" placeholder="votre avis ici..." required></textarea>
...
<span class="total"><?=$comments_info['total_comments']?> Avis</span>
<a href="#" class="write_comment_btn" data-comment-id="-1">Laissez votre avis.</a>
</div>
