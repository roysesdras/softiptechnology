      ...
      <div class="container ">
        ...
        <div class="col-md-3 order-md-2 order-1">
          <div class="position-sticky" style="top: 2rem">
                      ...
                      <div class="row">
                          <p>Étendue sur une période de six mois, notre programme met l’accent à 90% sur la pratique, les 10% restants sont dédiés à la théorie pour consolider vos bases. <br>
                          <input type="button" class="get-started" onclick="window.open('https://api.whatsapp.com/send?phone=22996735000&text=Bonjour,%20j\'aimerais%20avoir%20plus%20d\'informations%20sur%20la%20formation%20en%20graphisme','_blank')" value="Plus d'information">
                          </p>
                      </div>
                  </div>
          </div>
